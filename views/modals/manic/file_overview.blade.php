<div class="row gutter">
    ...
    <div class="col-md-12">
        <div class="card" style="background: lightgray;  border-radius: 10px; }">
            <div class="card-body">
                <ul class="statistics shorts-fsum">
...
<script>
    $(document).ready(function() {
        var app_stats = {!! json_encode(ManicStatsController::manic_sfile_stat($id, $file)) !!};
        sc_file_stat(app_stats['date'], app_stats['duration']);
